    ...
    checkValidateInput = () => {
        ...
        for (let i = 0; i < arrCheck.length; i++) {
            if (!this.state[arrCheck[i]]) {
                isValid = false
                alert("Missing value: " + arrCheck[i])
                break;
            }
        }
            ...
            <div className='user-redux-container'>
                ...
                <div className='user-redux-body'>
                    <div className='container'>
                        <div className='row'>
                            <div className='col-12 my-3 h4'><FormattedMessage id="manage-user.add" /></div>
                            <div className='col-3'>
                            ...
                            <div className='col-12 mt-3'>
                                ...
                                >
                                    {this.state.action === CRUD_ACTIONS.EDIT ? <FormattedMessage id="manage-user.save" /> : <FormattedMessage id="manage-user.create" />}
                                </button>
                            </div>
